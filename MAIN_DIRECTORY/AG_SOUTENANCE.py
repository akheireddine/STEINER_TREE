...
t1 = time.time()
if heuristic == "ACM":
    WG.algorithme_genetique_elitiste(N, WG.heuristique_ACPM, probaMutation, probaCroisement, RES, couple_instance_heuristic_opt)
elif heuristic == "PCC":
    WG.algorithme_genetique_elitiste(N, WG.heuristique_PCM, probaMutation, probaCroisement, RES, couple_instance_heuristic_opt)
else:
    print "Choisir heuristic"
t2 = time.time()
print "Algorithme genetique elitiste", min(RES), " temps  : ",t2-t1
